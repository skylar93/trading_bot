...
def main():
    ...
    # Data options
    parser.add_argument(
        "--exchange", default="binance", help="Exchange to fetch data from"
    )
    parser.add_argument(
        "--symbol", default="BTC/USDT", help="Trading pair symbol"
    )
    ...
    try:
        ...
        ray.init(
            ...
            object_store_memory=int(
                psutil.virtual_memory().total * 0.5
            ),  # Use 50% of system memory
        )
