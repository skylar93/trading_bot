...
def show_training():
    ...
    if st.button("Start Training", use_container_width=True, disabled=st.session_state['training_state']['is_training']):
        try:
            ...
            for episode in range(n_episodes):
                ...
                # Update metrics
                st.session_state['training_state']['metrics']['portfolio_values'].append(info['portfolio_value'])
                st.session_state['training_state']['metrics']['returns'].append(episode_reward)
                st.session_state['training_state']['metrics']['sharpe_ratios'].append(val_metrics['sharpe_ratio'])
                st.session_state['training_state']['metrics']['max_drawdowns'].append(val_metrics['max_drawdown'])
                
                # Update plot
                fig = update_metrics_plot(st.session_state['training_state']['metrics'])
