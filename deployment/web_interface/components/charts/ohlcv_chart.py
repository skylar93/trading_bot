...
class OHLCVChart:
    ...
    def _add_candlestick(self, data: pd.DataFrame):
    ...
    def _add_volume(self, data: pd.DataFrame):
        """Add volume bars"""
        colors = [
    ...
    def _add_moving_averages(self, data: pd.DataFrame):
    ...
    def _add_realtime_marker(
        self, data: pd.DataFrame, latest_data: Dict[str, Any]
    ):
