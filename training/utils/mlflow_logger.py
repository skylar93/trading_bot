...
class MLflowLogger:
    ...
    def log_params(self, params: Dict[str, Any]) -> None:
        ...
        try:
            ...
            params = {k: str(v) if isinstance(v, (dict, list)) else v
    ...
    def log_backtest_results(self, 
                           ...
                           artifact_path: str = "backtest_results") -> None:
        ...
        try:
            ...
            return {
                ...
                'metrics': {
                    ...
                    for name in best_run.filter(regex='^metrics\.').index.str.replace('metrics.', '')
                },
                'params': {
                    name: best_run[f"params.{name}"]
                    for name in best_run.filter(regex='^params\.').index.str.replace('params.', '')
                }
            }
